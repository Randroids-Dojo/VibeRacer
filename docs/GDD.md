...
| 8 | Race flow | partial (countdown with animated red/amber/green traffic light + synth beeps, per-track configurable checkpoint count, lap detection, invalid-lap reset, wrong-way warning banner, and the full HUD all live) |
