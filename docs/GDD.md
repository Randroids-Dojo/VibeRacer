...
- Best-ever for this track version (smaller, persistent; from KV). A small medal chip (Bronze, Silver, Gold, Platinum) sits beside it when the player's PB lands within 125% / 110% / 102% / 100% of the route's leaderboard #1 lap time.
- Lap counter.
