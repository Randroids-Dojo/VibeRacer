...
// Skid mark and tire smoke layers moved to ./effectLayers.ts. Re-exported
// here so existing imports from `@/game/sceneBuilder` keep working.
import {
  buildSkidMarkLayer,
  buildTireSmokeLayer,
  type SkidMarkLayer,
...
// Camera rig moved to ./cameraRig.ts. Re-exported here so existing imports
// from `@/game/sceneBuilder` keep working.
export {
  DEFAULT_CAMERA_RIG,
  initCameraRig,
  updateCameraRig,
