...
const REFERENCE_GP_LOOP: Piece[] = [
  ...
  { type: 'straight', row: 5, col: 1, rotation: 90 },
  { type: 'straight', row: 5, col: 0, rotation: 90 },
  ...
  { type: 'straight', row: -1, col: 7, rotation: 0 },
...
export const TRACK_TEMPLATES: TrackTemplate[] = [
  ...
  },
  {
    id: 'reference-gp',
    label: 'Reference GP',
    description: 'Miami-style replica with a long top straight, right stack, lower run, and diagonal start sector.',
